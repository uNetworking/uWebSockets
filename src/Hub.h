...
public:
	...
	WIN32_EXPORT void connect(const std::string& uri, void *user = nullptr, const std::map<std::string, std::string>& extraHeaders = {}, int timeoutMs = 5000, Group<CLIENT> *eh = nullptr);
