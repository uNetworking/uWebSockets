...
private:
    ...
    static bool setCompressed(uWS::WebSocketState<isServer> *, void *s) {
    ...
    static void forceClose(uWS::WebSocketState<isServer> *, void *s) {
    ...
    static bool refusePayloadLength(uint64_t length, uWS::WebSocketState<isServer> *, void *s) {
