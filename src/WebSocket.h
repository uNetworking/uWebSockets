...
private:
    ...
    uv_poll_t *next();
    operator bool();
    void write(char *data, size_t length, bool transferOwnership, void(*callback)(WebSocket webSocket, void *data, bool cancelled) = nullptr, void *callbackData = nullptr);
