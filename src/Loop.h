...
public:
    ...
    void addPostHandler(void *key, ofats::any_invocable<void(Loop *)> &&handler) {
        LoopData *loopData = (LoopData *) us_loop_ext((us_loop_t *) this);
    ...
    void addPreHandler(void *key, ofats::any_invocable<void(Loop *)> &&handler) {
        LoopData *loopData = (LoopData *) us_loop_ext((us_loop_t *) this);
    ...
    void defer(ofats::any_invocable<void()> &&cb) {
        LoopData *loopData = (LoopData *) us_loop_ext((us_loop_t *) this);
